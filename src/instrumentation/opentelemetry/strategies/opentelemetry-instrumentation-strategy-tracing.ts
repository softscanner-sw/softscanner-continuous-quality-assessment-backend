...
import { ApplicationInstrumentationMetadata, Instrumentation, InstrumentationGenerator, TelemetryExportDestination, TelemetryExportDestinationType, TelemetryExportProtocol } from "../../../core/instrumentation/instrumentation-core";
import { OpenTelemetryEventRegistry, OpenTelemetryInstrumentationConfig, OpenTelemetryUserInteractionEventsConfig } from "../opentelemetry-instrumentation";
import { OpenTelemetryInstrumentationStrategy, OpenTelemetryMainInstrumentationStrategy } from "./opentelemetry-instrumentation-strategy-core";
...
export class OpenTelemetryTracingInstrumentationStrategy extends OpenTelemetryMainInstrumentationStrategy {
    ...
    public generateImportations(): string {
        const config = (this._config as OpenTelemetryInstrumentationConfig);
    ...
    private generateTracerProviderAutoInstrumentationRegistration(): string {
        const automaticTracingOptions = (this._config as OpenTelemetryInstrumentationConfig).automaticTracingOptions;
